...
\begin{document}
    ...
    \input{content/relatedProjects}
    \input{content/buildingButter}
    \input{content/testbed}
    \input{content/discovery}
    \input{content/knownHostManagement}
    \input{content/widerDiscovery}
    \input{content/persistentInformationStorage}
    \input{content/persistentInformationRetrieval}
    \input{content/caseStudies}
    ...
    \input{appendix/originalObjectives}
    \input{appendix/originalTimeline}
    \input{appendix/revisedTimeline}
    \input{appendix/jxtaProtocolList}
